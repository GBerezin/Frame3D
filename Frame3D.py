...
frame.add_member('M12', 'N1', 'N2', E, G, I1y, Iz, J, A1)
frame.add_member('M23', 'N2', 'N3', E, G, I2y, Iz, J, A2)
frame.add_member('M34', 'N3', 'N4', E, G, I2y, Iz, J, A2)
frame.add_member('M25', 'N2', 'N5', E, G, I1y, Iz, J, A1)
frame.add_member('M56', 'N5', 'N6', E, G, I2y, Iz, J, A2)
frame.add_member('M45', 'N4', 'N5', E, G, I2y, Iz, J, A2)
...
frame.add_member_dist_load('M25', Direction='Fz', w1=-10, w2=-10, x1=0, x2=8, case='L')
frame.add_member_dist_load('M45', Direction='Fz', w1=-5, w2=-5, x1=0, x2=math.sqrt(4 ** 2 + 8 ** 2), case='L')
frame.add_member_dist_load('M45', Direction='Fx', w1=10, w2=10, x1=0, x2=math.sqrt(4 ** 2 + 8 ** 2), case='L')
frame.add_member_dist_load('M56', Direction='Fz', w1=-10, w2=-10, x1=0, x2=math.sqrt(4 ** 2 + 3 ** 2), case='L')
...
for i in frame.Nodes:
    pt.add_row([i, frame.Nodes[i].DX['1.0D+1.0L'], frame.Nodes[i].DZ['1.0D+1.0L'], frame.Nodes[i].RY['1.0D+1.0L']])
print(pt)
